...
public class GUISendProduct extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Indique la direccion de entrega");
        jPanel1.add(jLabel6);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Product selectedProduct = products.get(this.jComboBox1.getSelectedIndex());
        Delivery delivery = new Delivery(selectedProduct,Double.parseDouble(jTextField2.getText()), jTextField3.getText());
        delivery.setPrice(Double.parseDouble(jTextField4.getText()));
        delivery.setAddress(jTextField5.getText());
        delivery.setCity(jTextField6.getText());
        Gson gson = new Gson();
